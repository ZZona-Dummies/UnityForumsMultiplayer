...
public class ShipControl : NetworkBehaviour
{
    ...
    private void OnClientThrust(bool value)
    {
    ...
    private float frictionStopTimer = 0;
    ...
    private void DoHandler(int amount)
    {
